...
class PaymentService {
    ...
    addCheckoutEvent() {
        document.getElementById("checkout")
            ...
            let namePayment = document.getElementById("namePayment") as HTMLInputElement;
            let cpfPayment = document.getElementById("cpfPayment") as HTMLInputElement;
            let ccnPayment = document.getElementById("ccnPayment") as HTMLInputElement;
            let dataPayment = document.getElementById("dataPayment") as HTMLInputElement;
            let cvcPayment = document.getElementById("cvcPayment") as HTMLInputElement;
