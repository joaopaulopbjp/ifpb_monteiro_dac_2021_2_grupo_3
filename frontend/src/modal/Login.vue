<template>
  <div id="LoginVue" class="boxextern">
    ...
    <div class=" boxintern text-center p-5">
      ...
      <b-form-input id="usernameInputLogin" class="mt-4 form-input" placeholder="Username"></b-form-input>
      <b-form @submit.stop.prevent>
          <b-form-input id="passwordInputLogin" class="mt-3 form-input" type="password" placeholder="Password" aria-describedby="password-help-block" required></b-form-input>
      </b-form>
