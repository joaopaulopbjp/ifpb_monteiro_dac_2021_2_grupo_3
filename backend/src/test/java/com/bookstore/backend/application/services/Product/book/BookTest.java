...
public class BookTest {
    ...
    public void saveBookSucess() throws NotFoundException{
        ...
        book = new BookModel(0l, "teste", "livro de fantasia", 2000, 10, new BigDecimal(1.99), imageList, 
    ...
    public void findByTitleErrorPassing() throws NotFoundException{
        assertThrows(NotFoundException.class, () -> {bookService.findByTitle("adventure");});
    }
