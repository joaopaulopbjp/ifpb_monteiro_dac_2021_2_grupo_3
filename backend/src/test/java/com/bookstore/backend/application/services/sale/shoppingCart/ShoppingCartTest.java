...
public class ShoppingCartTest {
    ...
    public void addTest() throws NotFoundException {
        ...
        AuthorModel author = new AuthorModel(0l, "brito");
        ...
        book = bookService.save(book, categoryListId, userModel.getId(), company.getId() , authorListId);

        shoppingCartModel.addItemOrderToItemList(new ItemOrderModel(0l, 1, book));
        
        shoppingCartModel = shoppingCartService.add(shoppingCartModel, userModel.getId(), book.getId());

        List<ItemOrderModel> itemOrderList = itemOrderRepositoryService.getInstance().findAll();
